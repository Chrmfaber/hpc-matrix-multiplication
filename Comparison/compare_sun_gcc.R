...
Gcc630_O3kmn <- read.table("~/Google Drive/10.semester/02614 HPC/Assignment 1/GIT/SunO2andGcc630/DataGcc630_O3/Gcc630_O3kmn.dat", quote="\"", comment.char="")
Gcc630_O3kmn <- Gcc630_O3kmn[1:2]
Gcc630_O3kmn$TYPE <- "kmn"
Gcc630_O3mkn <- read.table("~/Google Drive/10.semester/02614 HPC/Assignment 1/GIT/SunO2andGcc630/DataGcc630_O3/Gcc630_O3mkn.dat", quote="\"", comment.char="")
Gcc630_O3mkn <- Gcc630_O3mkn[1:2]
Gcc630_O3mkn$TYPE <- "mkn"
gcc630_O3_best <- rbind(Gcc630_O3kmn,Gcc630_O3mkn)
gcc630_O3_best$TYPE <- interaction( "gcc630:O3", gcc630_O3_best$TYPE, sep = ":")

best = rbind(Sun_O5_best,gcc_O3_best,gcc630_O3_best)
